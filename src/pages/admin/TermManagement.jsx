...
const columns = [
    { header: 'Nombre de usuario', accessor: 'param_key' },
    { header: 'Entidad', accessor: 'param_value' },
    { header: 'Rol', accessor: 'param_value' },
    { header: 'Tipo de termino', accessor: 'param_value' },
    { header: 'Version', accessor: 'param_value' },
    { header: 'User Agent', accessor: 'param_value' },
    { header: 'Fecha de aceptacion', accessor: 'param_value' }
];
...
const TermManagement = () => {
    ...
    return (
        <div className="w-full min-h-screen">
            <HeaderCard
                title={"Bitacora de terminos y condiciones"}
                buttonText={"parámetro"}
                onButtonClick={handleCreate}
                description={"Administre la aceptación de terminos y condiciones de sus pagadores y proveedores."}
                icon={<FaCog />}
            />
