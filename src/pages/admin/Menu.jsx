...
const menuItems = [
  ...
  },
  {
    ...
    icon: FaCreditCard,
    title: "Gestion de lineas de credito",
...

  {
    ...
    icon: FaCalendarAlt,
    title: "Gestion de dias feriados",
    description: "Supervisa y administra los días feriados del año.",
  },
  {
    id: "param-management",
    icon: FaCog,
    title: "Gestion de parametros",
    description: "Controla los parametros de configuración del sistema.",
  },
];
