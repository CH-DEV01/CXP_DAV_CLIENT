...
import { uploadFile } from '../../services/admin/uploadFileService.js';
...
const UploadFilePageAdmin = () => {
    ...
    const [ creditLineLevel, setCreditLineLevel ] = useState(10);
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="mr-4 shadow-2xl w-full md:w-1/3 lg:w-1/4 bg-gradient-to-r from-red-600 to-red-800 bg-red-800 text-white p-4 rounded-xl overflow-y-auto font-montserrat">
                ...
                <PayerData entityName={selectedPayer.name} paymentPolicy={selectedPayer.paymentPolicy}></PayerData>
                                    ...
                                    <div className="flex justify-center">
                                        ...
                                        <div className="mt-2 w-full">
                                            <button
                                                ...
                                                className={`flex justify-center items-center cursor-pointer w-full py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-700 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 ${
