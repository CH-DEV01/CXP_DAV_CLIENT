...
const columns = [
    { header: 'Nombre Clave', accessor: 'key' },
    ...
    return (
        <div>
            <HeaderCard
                ...
                description={"Administre las altas y los accesos de los usuarios del sistema"}
                icon={<FaCog />}
            />
            ...
            ">
                <div className="relative w-full md:w-1/4 shadow-lg rounded-full"> 
                    <input
                        type="text"
