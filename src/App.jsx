...
import PayerCreditLineManagement from "./pages/admin/PayerCreditLineManager";
...
import uploadFilePage from "../src/pages/payer/UploadFilePage";
...
import PayerDocumentManagement from "./pages/payer/PayerDocumentManagement";
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={[ROLES.MANAGER]} />}>
          <Route path="admin" element={<Layout />}>
            ...
            />
            <Route
              path="payer-management-admin"
              element={<PayerManagementAdmin />}
            />
            <Route path="user-management" element={<UserManagement2 />} />
            <Route path="param-management" element={<ParamManagement />} />
            ...
            <Route
              path="payer-credit-line-management"
              element={<PayerCreditLineManager />}
            />
          </Route>
        </Route>
        ...
        <Route element={<ProtectedRoute allowedRoles={[ROLES.OPERATOR]} />}>
          <Route path="operator" element={<Layout />}>
            <Route index element={<ControlTerminal />} />
          </Route>
        </Route>

        <Route element={<ProtectedRoute allowedRoles={[ROLES.SUPPLIER]} />}>
          <Route
            path="select-agreement"
            element={<SelectAgreementToStart />}
          ></Route>
        ...
        <Route
          element={
            <ProtectedRoute
              allowedRoles={[ROLES.AUTHORIZING_TWO_MODE_AUTH]}
              requiredPermissions={[]}
            />
          }
        >
          <Route path="payer" element={<Layout />}>
            ...
            <Route path="documents-history" element={<PayerDocumentManagement />} />
          </Route>
        </Route>
